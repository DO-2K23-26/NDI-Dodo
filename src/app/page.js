            ...
            <div className=" h-screen overflow-y-scroll snap-y snap-mandatory">
               <div className="">
                  ...
                  <div className="h-screen snap-center">
                     <Card
                        title="Le climat"
                        text="Le climat correspond aux conditions météorologiques moyennes (températures, ensoleillement, humidité de l’air, vitesse des vents, etc.) d’une région donnée, durant une longue période.
...
"
                        topright="/feu_foret.jpg"
                        botleft="/feu_foret.jpg"
                     />
                  </div>
                  ...
                  <div className="h-screen snap-center">
                     <Card
                        ...
                        text="Une des causes du changement climatique actuel est l’effet de serre. Ces gaz, présents dans l’atmosphère, forment une « barrière » autour de la Terre et piègent la chaleur à la surface de la Terre.
...
"
                        botleft="/fumee-incendie-feu.jpg"
                        topright="/fumee-incendie-feu.jpg"
                     />
                  </div>
                  ...
                  <div className="h-screen snap-center">
                     <Card
                        title="Les principaux GES"
                        text="Les principaux GES et leur production:
Le dioxyde de carbone (CO2) 
Le méthane (CH4)
Le protoxyde d’azote (N2O) 
 Les gaz fluorés (CFC, HFC)
"
                        topright="/planete_temp.jpg"
                        botleft="/planete_temp.jpg"
                     />
                  </div>
               </div>
            </div>
